...
#  ]
  ...
  private
    ...
    def pfid_find_device
      params[:install_id] = params[:install_id].gsub(/\d|\W/, '')
      set_geoip_params unless params[:geo_ip_country_code]

      @app = find_app unless @app
      if !@app.present?
